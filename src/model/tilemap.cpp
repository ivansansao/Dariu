...
bool Tilemap::free_path_water(int i, int j) {
    const char til = this->getTileChar(i, j);
    return til == ' ' || til == 'Z' || til == 'Y' || til == 'O';
}
bool Tilemap::free_path_bullet(int i, int j) {
    const char til = this->getTileChar(i, j);
    return til == ' ' || til == '@' || til == 'P' || til == 'Q' || til == 'G' || til == 'X' || til == 'R' || til == '^' || til == 'V' || til == '>' || til == '<' || til == 'M' || til == 'H' || til == 'Z' || til == '#' || til == 'k' || til == 'K' || til == 'g' || til == 'x' || til == 'j' || til == 'L' || til == 'u' || til == 'J' || til == 'Y' || til == '.' || til == 'T' || til == '0' || til == '1' || til == '2' || til == '3' || til == '4' || til == '5' || til == '6' || til == '7' || til == '8' || til == '9' || til == 's' || til == 'h' || til == 'i' || til == 'f' || til == 'd' || til == 'l' || til == 'e' || til == 'd' || til == 'm' || til == 'c' || til == 'n' || til == 'O';
}

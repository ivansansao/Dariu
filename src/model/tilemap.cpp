...
std::string Tilemap::map[H] = {
    ...
    "B                                B                00000000000            B                         B",
    "B                                B                00000000000            B                         B",
    "B                                B               BBBBBBBBBBBBB           B      00000000    00000  B",
    "B         0                      B                                       B                  0 T 0  B",
    "B         0                      B                                       B      BBBBBBBB    00 00  B",
    "B         0      00000000000     B                                       B00000             BBBBB  B",
    "B        BBBB    00000000000     BBBBBB                                  BBBBBB                    B",
    "B                                B     B                     0           B                         B",
    "B             BBBBBBBBBBBBBBBB 0 B      B         0   0     000        T B      00000              B",
    "B 0                              B       B        0 0 0    00000         B      BBBBB              B",
    "B 0       0 0 0 0             BBBB        BBB     0 0 0               BBBB00000                    B",
    "B 0                              B                                       BBBBBB                    B",
    "BBB                              B             BBBBB                     B       0000000           B",
    "B              BB                BB    BBBB            BB              BBBBB     BBBBBBB           B",
    "B        0     BB         BB           BB              BB 0000000                                  X",
    "B    B         BB         BB           BB    B000000000BB 0000000 BB                               X",
    "B    B  000    BB    0    BB           BB    B000000000BB 0000000 BB                               X",
    "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"};
